...
int main(int argc, char** argv) {
    ...
    // use the name of our server, which is: example_action (named in my_action_server.cpp)
    // the "true" argument says that we want our new client to run as a separate thread (a good idea)
    actionlib::SimpleActionClient<my_action_server::demoAction> action_client("example_action", true);
